...
extension Params {
  static func stub(population: Int = Params.defaults.population,
                   ...
                   generatedBarrier: GeneratedBarrier? = Params.defaults.generatedBarrier,
                   shouldPersistManualBarriers: Bool = Params.defaults.shouldPersistManualBarriers,
                   replaceBarrier: (GeneratedBarrier, Int)? = Params.defaults.replaceBarrier,
